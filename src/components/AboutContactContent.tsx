...
import { Mail, MapPin, Phone, Send, Building2, CheckCircle2, ArrowUpRight } from "lucide-react";
        ...
        <section className="py-20 px-6 lg:px-12 border-b border-border bg-surface">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="max-w-2xl text-muted-foreground text-base mt-4 leading-relaxed">
              ...
              minimalist experience. Learn about Agnel Polytechnic, Vashi and get in touch with our team.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 px-6 lg:px-12 border-b border-border">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7 space-y-6 text-sm text-muted-foreground leading-relaxed">
              <p>
                Agnel Polytechnic in Vashi, Navi Mumbai, was started in 1983 with only one program — Diploma
                in Civil Engineering. It has grown since then, and today we offer five forward-looking
                branches of study: <strong className="text-foreground">Civil Engineering, Mechanical Engineering, Automobile Engineering, Electronics & Computer Engineering, and Artificial Intelligence & Machine Learning.</strong>
              </p>
              <p>
                What makes Agnel Polytechnic a unique institution in Mumbai is its discipline, ethical culture,
                and the dedication of the faculty in imparting knowledge and expertise to the students in a
                cosmopolitan atmosphere.
              </p>
              <p>
                <strong className="text-foreground">APV E-Cell (Agnel Polytechnic Vashi Entrepreneurship Cell)</strong>{" "}
                is our passionate student-driven initiative focused on nurturing entrepreneurial mindsets
                across all disciplines. We believe true entrepreneurship is not just about starting companies—it’s
                about fostering creativity, building resilience, and striving for meaningful social change.
                Through workshops, flagship competitions like <strong className="text-foreground">Pitchnova</strong>,
                mentorship, and networking opportunities, we inspire students to embrace innovation, learn
                from failure, and become the ethical leaders our world needs.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="lg:col-span-5 space-y-8">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Whether you are an aspiring student founder, an industry mentor, or an investor looking
                  to attend Pitchnova, we would love to hear from you.
                </p>
              </div>
                ...
                {submitted ? (
                  <div className="py-12 text-center space-y-4 animate-fade-in">
                    ...
                    <p className="text-sm text-muted-foreground max-w-md mx-auto">
                      Thank you for reaching out to APV E-Cell. Our leadership or PR department will get
