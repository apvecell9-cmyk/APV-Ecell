...
export function DepartmentCard({
  ...
  return (
    <div
      className="group relative rounded-xl border border-border bg-surface hover:bg-background transition-all duration-500 overflow-hidden p-8 flex flex-col justify-between min-h-[420px] shadow-soft hover:shadow-lg hover:border-primary/30"
