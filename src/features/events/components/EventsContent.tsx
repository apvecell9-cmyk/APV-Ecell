...
import { PdfUploadSystem } from "@/features/events/components/PdfUploadSystem";
...
export function EventsContent() {
  const defaultEvent = events[0] as EventItem;
  const [selectedEvent, setSelectedEvent] = useState<EventItem>(defaultEvent);
  ...
  return (
    <PageLayout>
      ...
      {/* Events List + Event Tile Preview */}
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          {/* Left: Interactive Events List with Arrow Animation */}
